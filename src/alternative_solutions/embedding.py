...
class TextProcessor:
    ...
    def case_correct_word(self, word: str):
        ...
        then it is replaced with regular casing.
        E.g.
        - pytorch -> PyTorch
        - llm -> LLM
...
class ReadmeCleaner:
    ...
    def remove_markdown_tables(self, text: str) -> str:
        ...
        for i, line in enumerate(lines):
            ...
            # If in a table, skip lines that look like table rows
            if in_table:
            ...
            # Skip standalone lines that resemble tables but weren’t preceded by a header+alignment
